...
def load_data():
        ...
        ###FOR GITHUB
        _get_state1 = st.session_state.file1
        _get_state2 = st.session_state.file2
        #st.write(_get_state1)
        #st.write(_get_state2)
        df1=_get_state1
        df2=_get_state2
...
def plot_imbalance_heatmap(df,metric):
                ...
                sns.heatmap(demand_by_hour_weekday, cmap=cmap1, ax=ax,vmin=df1[metric].min(), vmax=df1[metric].max())
